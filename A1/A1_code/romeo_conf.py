...
### TODO ###
w_com = 1.0  # weight of center of mass task (default=1)
w_cop = 0.0  # weight of center of pressure task (default=0)
w_am = 1e-4  # weight of angular momentum task (default=1e-6)
w_foot = 1e2  # weight of the foot motion task (default=1e0)
w_contact = 1e2  # weight of the foot in contact (default=1e2)
w_posture = 1e-2  # weight of joint posture task (default=0)
w_forceRef = 1e-5  # weight of force regularization task (default=1e-5)
w_torque_bounds = 1.0  # weight of the torque bounds (default=1)
w_joint_bounds = 1.0  # (default=1)
...
from pinocchio.visualize import MeshcatVisualizer #<-- import corretto
